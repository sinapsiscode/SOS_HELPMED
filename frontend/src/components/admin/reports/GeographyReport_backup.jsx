    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
          ...
          <div className="mt-2">
            <span className="text-sm text-gray-600">
              {labels.kpis.units
                .replace('{available}', kpis.availableUnits)
                .replace('{total}', kpis.activeUnits)}
            </span>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
          ...
          <div className="mt-2">
            <span className="text-sm text-green-600 font-medium">{labels.kpis.limaMetro}</span>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            <div className="text-center p-3 sm:p-4 bg-gradient-to-b from-green-50 to-green-100 rounded-lg border border-green-200">
              ...
              <h4 className="font-semibold text-green-800 text-sm sm:text-base">
                {labels.executive.cards.leader.title}
              </h4>
              <p className="text-xs sm:text-sm text-green-700">
                {labels.executive.cards.leader.description
                  .replace('{district}', 'Surco')
                  .replace('{count}', Math.floor(kpis.totalUsers * 0.18))}
              </p>
              <p className="text-xs text-green-600 mt-1">
                {labels.executive.cards.leader.percentage.replace('{percentage}', '18')}
              </p>
            </div>
            ...
            <div className="text-center p-3 sm:p-4 bg-gradient-to-b from-blue-50 to-blue-100 rounded-lg border border-blue-200">
              ...
              <h4 className="font-semibold text-blue-800 text-sm sm:text-base">
                {labels.executive.cards.fastest.title}
              </h4>
              <p className="text-xs sm:text-sm text-blue-700">
                {labels.executive.cards.fastest.description
                  .replace('{district}', 'Miraflores')
                  .replace('{time}', '7')}
              </p>
              <p className="text-xs text-blue-600 mt-1">
                {labels.executive.cards.fastest.percentage.replace('{percentage}', '25')}
              </p>
            </div>
            ...
            <div className="text-center p-3 sm:p-4 bg-gradient-to-b from-purple-50 to-purple-100 rounded-lg border border-purple-200">
              ...
              <h4 className="font-semibold text-purple-800 text-sm sm:text-base">
                {labels.executive.cards.opportunity.title}
              </h4>
              <p className="text-xs sm:text-sm text-purple-700">
                {labels.executive.cards.opportunity.description.replace('{district}', 'Callao')}
              </p>
              <p className="text-xs text-purple-600 mt-1">
                {labels.executive.cards.opportunity.average.replace('{time}', '18')}
              </p>
            </div>
          </div>
        </div>
...
// Componente eliminado temporalmente
// TODO: Limpiar componentes no utilizados
...
const ServicesTrendChart = ({ dateRange }) => {
  ...
  const servicesData = {
    last30days: [
      {
        period: labels.serviceTrend.periods.days30,
        emergencias: 45,
        urgencias: 32,
        domicilio: 28,
        traslados: 12
      ...
      {
        period: labels.serviceTrend.periods.days25,
        emergencias: 52,
        urgencias: 38,
        domicilio: 31,
        traslados: 15
      ...
      {
        period: labels.serviceTrend.periods.days20,
        emergencias: 48,
        urgencias: 35,
        domicilio: 29,
        traslados: 14
      ...
      {
        period: labels.serviceTrend.periods.days15,
        emergencias: 58,
        urgencias: 42,
        domicilio: 35,
        traslados: 18
      ...
      {
        period: labels.serviceTrend.periods.days10,
        emergencias: 61,
        urgencias: 45,
        domicilio: 38,
        traslados: 20
      ...
      {
        period: labels.serviceTrend.periods.days5,
        emergencias: 65,
        urgencias: 48,
        domicilio: 41,
        traslados: 22
      ...
      {
        period: labels.serviceTrend.periods.today,
        emergencias: 70,
        urgencias: 52,
        domicilio: 45,
        traslados: 25
    ...
    last3months: [
      {
        period: labels.serviceTrend.periods.months3,
        emergencias: 420,
        urgencias: 310,
        domicilio: 280,
        traslados: 95
      ...
      {
        period: labels.serviceTrend.periods.months2,
        emergencias: 465,
        urgencias: 340,
        domicilio: 315,
        traslados: 110
      ...
      {
        period: labels.serviceTrend.periods.lastMonth,
        emergencias: 510,
        urgencias: 375,
        domicilio: 350,
        traslados: 125
      ...
      {
        period: labels.serviceTrend.periods.thisMonth,
        emergencias: 580,
        urgencias: 420,
        domicilio: 385,
        traslados: 145
  ...
  const maxValue = Math.max(
    ...data.flatMap((d) => [d.emergencias, d.urgencias, d.domicilio, d.traslados])
  )
            ...
            {data.map((point, index) => {
              ...
              return (
                <div key={index} className="flex-1 flex flex-col items-center group relative">
                  {/* Barra apilada */}
                  <div
                    className="relative w-12 flex flex-col-reverse"
                  ...
                  >
                    ...
                    <div
                      ...
                      title={labels.serviceTrend.tooltips.transfers.replace(
                        '{count}',
                        point.traslados
                      )}
                    ></div>
                    ...
                    <div
                      ...
                      title={labels.serviceTrend.tooltips.homeVisits.replace(
                        '{count}',
                        point.domicilio
                      )}
                    ></div>
                    ...
                    <div
                      ...
                      title={labels.serviceTrend.tooltips.urgencies.replace(
                        '{count}',
                        point.urgencias
                      )}
                    ></div>
                    ...
                    <div
                      ...
                      title={labels.serviceTrend.tooltips.emergencies.replace(
                        '{count}',
                        point.emergencias
                      )}
                    ></div>
                  ...
                  <div className="absolute -top-6 text-xs font-semibold text-gray-700">{total}</div>
                    ...
                    <div className="space-y-1">
                      <div className="flex items-center justify-between">
                        <span className="flex items-center">
                          ...
                          {labels.serviceTrend.legend.emergencies}:
                        </span>
                      ...
                      <div className="flex items-center justify-between">
                        <span className="flex items-center">
                          ...
                          {labels.serviceTrend.legend.urgencies}:
                        </span>
                      ...
                      <div className="flex items-center justify-between">
                        <span className="flex items-center">
                          ...
                          {labels.serviceTrend.legend.homeVisits}:
                        </span>
                      ...
                      <div className="flex items-center justify-between">
                        <span className="flex items-center">
                          ...
                          {labels.serviceTrend.legend.transfers}:
                        </span>
...
const UserGrowthChart = ({ dateRange }) => {
  ...
  const avgGrowth =
    data.length > 1 ? ((data[data.length - 1].total / data[0].total - 1) * 100).toFixed(1) : 0
      ...
      <div className="h-80 relative mb-4">
        ...
        <div className="ml-10 mr-4 h-full pb-8 relative">
          ...
          <div className="relative h-full flex items-end justify-between px-2">
            {data.map((point, index) => {
              ...
              return (
                <div key={index} className="flex-1 flex flex-col items-center group relative">
                  <div
                    className="relative w-14 flex flex-col-reverse"
                    style={{ height: `${totalHeight}px` }}
                  >
                  ...
                  <div className="invisible group-hover:visible absolute -top-32 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white p-3 rounded-lg text-xs whitespace-nowrap z-20 shadow-lg">
                    ...
                    <div className="space-y-1">
                      <div className="flex items-center justify-between">
                        <span className="flex items-center">
                          <div className="w-2 h-2 bg-blue-500 rounded mr-2"></div>Familiar:
                        </span>
                        <span className="font-semibold ml-2">{point.familiar}</span>
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="flex items-center">
                          <div className="w-2 h-2 bg-green-500 rounded mr-2"></div>Corporativo:
                        </span>
                        <span className="font-semibold ml-2">{point.corporativo}</span>
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="flex items-center">
                          <div className="w-2 h-2 bg-purple-500 rounded mr-2"></div>Externo:
                        </span>
          ...
          <div className="absolute -bottom-8 left-0 right-0 flex justify-between text-xs text-gray-500 px-2">
            {data.map((point, index) => (
              <div key={index} className="text-center flex-1">
                <span className="block">{point.period}</span>
              </div>
            ))}
          </div>
        </div>
                ...
                <td className="text-center py-3">
                  <span
                    className={`px-2 py-1 rounded-full text-xs font-medium ${
                      plan.utilizationRate > 80
                        ? 'bg-red-100 text-red-800'
                        : plan.utilizationRate > 60
...
const UserRegistrationChart = ({ dateRange }) => {
  ...
  const calculateRegistrationAnalysis = () => {
    ...
    const requestsByType = {
      ...
      corporativo:
        registrationRequests?.filter((req) => req.planType === 'corporativo').length || 0,
    ...
    return {
      ...
      totalRequests:
        requestsByStatus.pending + requestsByStatus.approved + requestsByStatus.rejected
    }
  }
      ...
      <div className="space-y-8">
        ...
        <div>
          <h4 className="font-medium text-gray-800 mb-4">
            {labels.registrationAnalysis.userStatus.title}
          </h4>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-4">
              ...
              <div className="mt-2 text-xs text-green-600">
                {analysis.totalUsers > 0
                  ? Math.round((analysis.usersByStatus.active / analysis.totalUsers) * 100)
                  : 0}
                % del total
              </div>
            </div>
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-2xl font-bold text-gray-600">
                    {analysis.usersByStatus.inactive}
                  </div>
              ...
              <div className="mt-2 text-xs text-gray-600">
                {analysis.totalUsers > 0
                  ? Math.round((analysis.usersByStatus.inactive / analysis.totalUsers) * 100)
                  : 0}
                % del total
              </div>
            </div>
        ...
        <div>
          <h4 className="font-medium text-gray-800 mb-4">
            {labels.registrationAnalysis.requestStatus.title}
          </h4>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-xl sm:text-2xl font-bold text-yellow-600">
                    {analysis.requestsByStatus.pending}
                  </div>
                  <div className="text-xs sm:text-sm text-yellow-700">
                    {labels.registrationAnalysis.requestStatus.pending}
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-xl sm:text-2xl font-bold text-green-600">
                    {analysis.requestsByStatus.approved}
                  </div>
                  <div className="text-xs sm:text-sm text-green-700">
                    {labels.registrationAnalysis.requestStatus.approved}
                  </div>
                </div>
                <div className="text-green-500">
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-4">
              <div className="flex items-center justify-between">
                <div>
                  <div className="text-2xl font-bold text-red-600">
                    {analysis.requestsByStatus.rejected}
                  </div>
                  <div className="text-sm text-red-700">
                    {labels.registrationAnalysis.requestStatus.rejected}
                  </div>
                </div>
        ...
        <div>
          <h4 className="font-medium text-gray-800 mb-4">
            {labels.registrationAnalysis.planRequests.title}
          </h4>
          <div className="space-y-3">
            {/* Planes Familiares */}
            <div className="flex items-center space-x-4">
              <div className="w-24 text-sm font-medium text-gray-700">
                {labels.registrationAnalysis.planRequests.familiar}
              </div>
              ...
              <div className="w-12 text-right text-sm font-semibold text-gray-600">
                {analysis.totalRequests > 0
                  ? Math.round((analysis.requestsByType.familiar / analysis.totalRequests) * 100)
                  : 0}
                %
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              <div className="w-24 text-sm font-medium text-gray-700">
                {labels.registrationAnalysis.planRequests.corporate}
              </div>
              <div className="flex-1 relative">
                <div className="w-full bg-gray-200 rounded-full h-6">
                  <div
              ...
              <div className="w-12 text-right text-sm font-semibold text-gray-600">
                {analysis.totalRequests > 0
                  ? Math.round((analysis.requestsByType.corporativo / analysis.totalRequests) * 100)
                  : 0}
                %
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              <div className="w-24 text-sm font-medium text-gray-700">
                {labels.registrationAnalysis.planRequests.external}
              </div>
              <div className="flex-1 relative">
                <div className="w-full bg-gray-200 rounded-full h-6">
                  <div
              ...
              <div className="w-12 text-right text-sm font-semibold text-gray-600">
                {analysis.totalRequests > 0
                  ? Math.round((analysis.requestsByType.externo / analysis.totalRequests) * 100)
                  : 0}
                %
              </div>
            </div>
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-amber-700 mt-1">
                  Hay {analysis.requestsByStatus.pending} solicitud(es) de registro pendiente(s) que
                  requieren revisión.
                </p>
              </div>
            </div>
...
const ActiveUsersTable = ({ dateRange, filterType }) => {
  ...
  const getActiveUsers = () => {
    ...
    return usersData.sort((a, b) => b.servicesUsed - a.servicesUsed).slice(0, 20) // Top 20 usuarios más activos
  }
    ...
    <div className="bg-white rounded-xl shadow-medium p-6">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="text-sm text-gray-600">
          {labels.districtAnalysis.filters.label}{' '}
          <span className="font-medium">
            {filterType === 'all' ? labels.districtAnalysis.filters.all : filterType}
          </span>
        </div>
      </div>
            ...
            <thead>
              <tr className="border-b bg-gray-50">
                <th className="text-left py-3 px-4 font-medium text-gray-700">
                  {labels.activeUsers.headers.user}
                </th>
                <th className="text-left py-3 px-4 font-medium text-gray-700">
                  {labels.activeUsers.headers.type}
                </th>
                <th className="text-left py-3 px-4 font-medium text-gray-700">
                  {labels.activeUsers.headers.plan}
                </th>
                <th className="text-center py-3 px-4 font-medium text-gray-700">
                  {labels.planAnalysis.headers.servicesUsed}
                </th>
                <th className="text-center py-3 px-4 font-medium text-gray-700">
                  {labels.planAnalysis.headers.utilization}
                </th>
                <th className="text-center py-3 px-4 font-medium text-gray-700">
                  {labels.activeUsers.headers.status}
                </th>
                <th className="text-left py-3 px-4 font-medium text-gray-700">
                  {labels.activeUsers.headers.memberSince}
                </th>
              </tr>
            </thead>
            <tbody>
              {activeUsers.map((user, index) => (
                <tr key={user.id} className="border-b hover:bg-gray-50">
                      ...
                      <div>
                        ...
                        {user.employees > 0 && (
                          <div className="text-xs text-gray-500">
                            {labels.planAnalysis.stats.employees.replace('{count}', user.employees)}
                          </div>
                        )}
                      </div>
                    </div>
                  ...
                  <td className="py-3 px-4 text-center">
                    ...
                    <div className="text-xs text-gray-500">
                      de {user.servicesUsed + user.servicesRemaining}
                    </div>
                  </td>
                  <td className="py-3 px-4 text-center">
                      ...
                      <div className="w-16 bg-gray-200 rounded-full h-2 mr-2">
                        <div
                          className={`h-2 rounded-full ${
                            user.utilizationRate >= 80
                              ? 'bg-red-500'
                              : user.utilizationRate >= 60
                                ? 'bg-yellow-500'
                                : 'bg-green-500'
                          }`}
                  ...
                  <td className="py-3 px-4 text-center">
                    ...
                    >
                      {user.status === 'active'
                        ? labels.activeUsers.status.active
                        : labels.activeUsers.status.inactive}
                    </span>
                  </td>
        ...
        <div className="mt-4 pt-4 border-t grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
          <div className="text-center p-2">
            ...
            <div className="text-xs sm:text-sm text-gray-600">
              {labels.serviceUtilization.distribution}
            </div>
          </div>
          <div className="text-center p-2">
            <div className="text-xl sm:text-2xl font-bold text-green-600">
              {Math.round(
                activeUsers.reduce((sum, user) => sum + user.utilizationRate, 0) /
                  activeUsers.length
              )}
              %
            </div>
  ...
  const calculateTimeDistribution = () => {
    ...
    const averageTime =
      responseTimes.length > 0
        ? Math.round(
            (responseTimes.reduce((sum, time) => sum + time, 0) / responseTimes.length) * 10
          ) / 10
        : 0
    ...
    const summary =
      total > 0
        ? labels.responseTime.percentage.replace(
            '{percentage}',
            Math.round((fastResponses / total) * 100)
          )
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-4 gap-3 mb-4">
            ...
            <div className="text-center p-3 bg-green-50 rounded-lg border border-green-200">
              <div className="text-lg font-bold text-green-600">
                {distribution.stats.minTime}min
              </div>
          ...
          <div className="space-y-3">
            {distribution.ranges.map((range, index) => {
              const percentage =
                distribution.total > 0 ? (range.count / distribution.total) * 100 : 0
              return (
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-4 rounded-lg border border-blue-200">
            ...
            <div className="grid grid-cols-3 gap-3 text-center">
              {['sos', 'medical', 'urgency'].map((type) => {
                const typeEmergencies =
                  activeEmergencies?.filter((e) => e.type === type && e.status === 'completed') ||
                  []
                const avgTimeForType =
                  typeEmergencies.length > 0
                    ? Math.round(
                        (typeEmergencies.reduce((sum, e) => sum + (e.responseTimeMinutes || 0), 0) /
                          typeEmergencies.length) *
                          10
                      ) / 10
                    : 0
                ...
                <p className="text-xs text-green-700 mt-1">
                  ...
                  {distribution.stats.responseTimes.length > 0 && (
                    <span>
                      {' '}
                      •{' '}
                      {labels.emergencyDensity.averageTime.replace(
                        '{time}',
                        distribution.stats.avgTime
                      )}
                    </span>
                  )}
                </p>
...
const UnitUtilizationChart = ({ dateRange, ambulanceUsers, utilization }) => {
  ...
  const calculateDetailedUtilization = () => {
    ...
    const activeUnits =
      statusCounts.available.count + statusCounts.en_route.count + statusCounts.busy.count
  ...
  return (
    <div className="bg-white rounded-xl shadow-medium p-6">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="text-sm text-gray-600">Disponibilidad: {utilization.value}</div>
      </div>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {details.statusBreakdown.map((status, index) => {
              const percentage =
                details.totalUnits > 0 ? (status.count / details.totalUnits) * 100 : 0
              return (
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-green-600 mt-1">
                  ...
                  {details.statusBreakdown.find((s) => s.status === 'busy')?.count || 0} ocupadas)
                </p>
              </div>
  ...
  const generateAlerts = () => {
    ...
    if (responseTime.status === 'critical') {
      alerts.push({
        ...
        message: labels.alerts.responseTimeCritical.description.replace(
          '{district}',
          `Promedio actual: ${responseTime.value}`
        ),
        color: 'red'
      })
      ...
      alerts.push({
        ...
        message: labels.alerts.responseTimeHigh.description.replace(
          '{district}',
          `Promedio actual: ${responseTime.value}`
        ),
        color: 'yellow'
    ...
    if (unitUtilization.status === 'critical' || unitUtilization.status === 'warning') {
      alerts.push({
        ...
        message: labels.alerts.unitsLow.description
          .replace('{active}', unitUtilization.activeUnits)
          .replace('{total}', unitUtilization.totalUnits),
    ...
    <div className="bg-white rounded-xl shadow-medium p-6">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center space-x-2">
          ...
          >
            {alerts.length === 0
              ? labels.alerts.allGood.title
              : alerts.some((a) => a.level === 'critical')
                ? labels.alerts.critical
                : labels.alerts.warning}
          </span>
        </div>
      </div>
          ...
          <div className="bg-green-50 border-l-4 border-green-400 p-4">
            <div className="flex">
              ...
              <div>
                ...
                <p className="text-green-700 text-sm">{labels.alerts.allGood.description}</p>
              </div>
            </div>
          </div>
        )}
      ...
      <div className="mt-4 pt-4 border-t">
        <div className="grid grid-cols-3 gap-4">
          <div className="text-center">
            <div
              className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${
                responseTime.status === 'excellent' || responseTime.status === 'good'
                  ? 'bg-green-100 text-green-800'
          ...
          <div className="text-center">
            <div
              className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${
                satisfaction.status === 'excellent' || satisfaction.status === 'good'
                  ? 'bg-green-100 text-green-800'
                  : satisfaction.status === 'warning'
                    ? 'bg-yellow-100 text-yellow-800'
                    : 'bg-red-100 text-red-800'
              }`}
            >
          ...
          <div className="text-center">
            <div
              className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${
                unitUtilization.status === 'excellent' || unitUtilization.status === 'good'
                  ? 'bg-green-100 text-green-800'
                  : unitUtilization.status === 'warning'
                    ? 'bg-yellow-100 text-yellow-800'
                    : 'bg-red-100 text-red-800'
              }`}
            >
...
const UnifiedDistrictAnalysis = ({ dateRange }) => {
  ...
  const getUnifiedDistrictData = () => {
    ...
    unifiedData.forEach((district) => {
      district.percentage =
        totalServices > 0 ? Math.round((district.services / totalServices) * 100 * 10) / 10 : 0
    })
            ...
            >
              ...
              <div className="flex items-center justify-between sm:justify-start sm:space-x-4 sm:ml-4">
                <div className="text-left sm:text-right">
                  ...
                  >
                    <i
                      className={`fas fa-arrow-${district.trend.startsWith('+') ? 'up' : 'down'} mr-1`}
                    ></i>
                    {district.trend}
                  </span>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          <div className="text-center">
            ...
            <p className="text-xs sm:text-sm text-gray-600">
              {labels.districtAnalysis.cards.totalServices}
            </p>
          </div>
          <div className="text-center">
            ...
            <p className="text-xs sm:text-sm text-gray-600">
              {labels.districtAnalysis.cards.totalUsers}
            </p>
          </div>
          <div className="text-center">
...
const calculatePlanSummary = (allUsers) => {
  ...
  Object.entries(familiarPlans).forEach(([planName, data]) => {
    summary.push({
      ...
      utilizationRate:
        data.totalServices > 0 ? Math.round((data.usedServices / data.totalServices) * 100) : 0
    })
  })
  ...
  if (allUsers.corporativo && allUsers.corporativo.length > 0) {
    ...
    summary.push({
      ...
      utilizationRate:
        corporateData.totalServices > 0
          ? Math.round((corporateData.usedServices / corporateData.totalServices) * 100)
          : 0
    })
  }
  ...
  if (allUsers.externo && allUsers.externo.length > 0) {
    ...
    summary.push({
      ...
      utilizationRate:
        externalData.totalServices > 0
          ? Math.round((externalData.usedServices / externalData.totalServices) * 100)
          : 0
    })
  }
  ...
  return (
    <div className="bg-white rounded-xl shadow-medium p-6">
      ...
      <div className="mt-6 space-y-4">
        <div className="text-center">
          <span
            className={`px-3 py-1 rounded-full text-sm font-medium ${getUtilizationColor(utilization)}`}
          >
...
const ServiceTypeDistributionReal = ({ serviceMetrics }) => {
  const totalServices = Object.values(serviceMetrics).reduce(
    (sum, metric) => sum + (metric.total || 0),
    0
  )
        ...
        <>
          <div className="space-y-4">
            {serviceData.map((service, index) => (
              <div key={index} className="flex items-center space-x-4">
                <div className="w-24 text-sm font-medium text-gray-700">{service.type}</div>
                <div className="flex-1 relative">
                  <div className="w-full bg-gray-200 rounded-full h-6">
                    <div
                    ...
                    >
                      <span className="text-white text-xs font-semibold">{service.count}</span>
                    </div>
                  </div>
                </div>
                <div className="w-12 text-right text-sm font-semibold text-gray-600">
  ...
  const calculatePlanUtilization = () => {
    ...
    if (allUsers.corporativo) {
      allUsers.corporativo.forEach((user) => {
        ...
        planData[planName].totalServices +=
          user.plan?.contract_services || user.company?.contracted_services || 50
      })
    }
  ...
  const calculateDetailedAnalysis = () => {
    ...
    if (allUsers.corporativo && allUsers.corporativo.length > 0) {
      const corporateData = {
        ...
        services: {
          EMERGENCIA: {
            used: allUsers.corporativo.reduce(
              (sum, user) => sum + (user.service_usage?.current_period?.used_services || 0),
              0
            ),
            limit: allUsers.corporativo.reduce(
              (sum, user) =>
                sum + (user.plan?.contract_services || user.company?.contracted_services || 50),
              0
            )
          }
        }
        ...
        {Object.entries(zoneData).map(([zone, data]) => {
          ...
          return (
            <div key={zone} className="border rounded-lg p-4">
              ...
              <div className="text-xs text-gray-600">Cobertura: {data.districts.join(', ')}</div>
            </div>
          )
        })}
      </div>
    ...
    <div className="bg-white rounded-xl shadow-medium p-6">
      ...
      <div className="space-y-3">
        {Object.entries(densityData.timeSlots).map(([timeSlot, count], index) => {
          const percentage =
            densityData.total > 0 ? Math.round((count / densityData.total) * 100) : 0
      ...
      <div className="mt-4 p-3 bg-yellow-50 rounded-lg border border-yellow-200">
        ...
        <p className="text-xs text-yellow-700 mt-1">
          {
            Object.entries(densityData.timeSlots).reduce(
              (max, [slot, count]) => (count > max.count ? { slot, count } : max),
              { slot: '', count: 0 }
            ).slot
          }{' '}
          es el período de mayor actividad
        </p>
      </div>
    </div>
  )
