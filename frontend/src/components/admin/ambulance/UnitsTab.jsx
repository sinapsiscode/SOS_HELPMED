...
const UnitsTab = ({
  ...
  if (!Array.isArray(ambulances)) {
    console.error('UnitsTab: ambulances debe ser un array')
    return null
  }

  if (!Array.isArray(filteredAmbulances)) {
    console.error('UnitsTab: filteredAmbulances debe ser un array')
    return null
  }

  if (typeof onEdit !== 'function') {
    console.error('UnitsTab: onEdit debe ser una función')
    return null
  }

  if (typeof onDelete !== 'function') {
    console.error('UnitsTab: onDelete debe ser una función')
    return null
  }
      ...
      <div className="bg-white rounded-xl shadow-medium overflow-hidden mt-6">
        <div className="px-6 py-4 border-b border-gray-200">
          <h3 className="text-lg font-exo font-semibold text-gray-800">
            Unidades ({filteredAmbulances.length})
          </h3>
        </div>
        ...
        {filteredAmbulances.length === 0 ? (
          <div className="p-8 text-center">
            ...
            <h3 className="text-lg font-exo font-semibold text-gray-800 mb-2">No hay unidades</h3>
