    ...
    return (
      <div className="bg-red-50 border border-red-200 rounded-lg p-6">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-lg font-semibold text-red-800">Error en Asignaciones</h3>
      ...
      <div className="bg-white rounded-xl shadow-medium p-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="bg-red-50 border border-red-200 rounded-lg p-4 text-center">
            ...
            <div className="text-sm text-red-700 font-roboto">Alta Prioridad</div>
          </div>
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 text-center">
            <div className="text-2xl font-bold text-yellow-600 font-exo">{mediumPriorityCount}</div>
            <div className="text-sm text-yellow-700 font-roboto">Media Prioridad</div>
          </div>
          <div className="bg-green-50 border border-green-200 rounded-lg p-4 text-center">
            <div className="text-2xl font-bold text-green-600 font-exo">
              {availableUnits.length}
            </div>
            <div className="text-sm text-green-700 font-roboto">Unidades Disponibles</div>
          </div>
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-center">
            <div className="text-2xl font-bold text-blue-600 font-exo">{totalPending}</div>
            <div className="text-sm text-blue-700 font-roboto">Pendientes</div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-medium overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-200">
          <h3 className="text-lg font-exo font-semibold text-gray-800">
            Servicios Pendientes de Asignación ({totalPending})
          </h3>
        </div>
        ...
        {totalPending === 0 ? (
          <div className="p-8 text-center">
            ...
            <h3 className="text-lg font-exo font-semibold text-gray-800 mb-2">¡Excelente!</h3>
            <p className="text-gray-600 font-roboto">No hay servicios pendientes de asignación.</p>
          </div>
        ) : (
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                          ...
                          <p className="text-sm text-gray-600 font-roboto mb-1">
                            <strong>Plan:</strong> {emergency.planName}
                          </p>
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600 font-roboto mb-1">
                            <strong>Tiempo estimado:</strong> {emergency.estimatedResponseTime}
                          </p>
                          <p className="text-sm text-gray-600 font-roboto">
                      ...
                      <div className="bg-gray-50 rounded-lg p-4 space-y-4">
                        ...
                        <div>
                          ...
                          >
                            ...
                            <span>
                              {loading ? 'Procesando...' : 'Establecer Tiempo de Llegada'}
                            </span>
                          </button>
                          {emergency.estimatedArrivalTime && (
                            <p className="text-sm text-green-600 font-roboto mt-2">
                              <i className="fas fa-check-circle mr-1"></i>
                              Tiempo establecido: {emergency.estimatedArrivalTime} minutos
                            </p>
                          )}
                        </div>
                                ...
                                >
                                  ...
                                  <div className="flex-1">
                                    ...
                                    <div className="text-xs text-green-600 font-roboto">
                                      <i className="fas fa-circle mr-1"></i>Disponible
                                    </div>
                                    <div className="text-xs font-roboto mt-1">
                                      ...
                                      >
                                        ...
                                        {unit.distance.toFixed(1)} km • {unit.estimatedTime} min
                                      </span>
                                    </div>
                                  </div>
                                </button>
